      ...
      <div className="mx-auto w-full max-w-6xl px-6 py-12 sm:px-10 sm:py-16">
        <section>
          ...
          <p className="mt-5 max-w-3xl text-base leading-7 text-black/60 sm:text-lg">
            iBag is ready to understand your financial picture from the real
          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-base leading-7 text-black/60">
                Connect your financial accounts through Plaid. Once connected,
                iBag will begin processing the real financial data you
                authorize.
              </p>
            </div>
            ...
            <Link
              href="/connect"
              className="inline-flex shrink-0 items-center justify-center rounded-full bg-black px-7 py-4 text-sm font-medium text-white transition hover:bg-black/80"
            >
